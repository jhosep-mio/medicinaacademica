...
export const ScheamaProductos = Yup.object().shape({
  ...
  idCategoria: Yup.number().required("El campo es requerido"),
  id_profesor: Yup.number().required("El campo es requerido"),
...
export const SchemaCupones = Yup.object().shape({
  codigo: Yup.string().required("El campo es requerido"),
  montoMinimo: Yup.number().required("Tiene que indicar un monto mínimo"),
  tipoDescuento: Yup.string().required("Tiene que seleccionar el tipo de descuento"),
  valorDescuento: Yup.string().required("Ingrese el valor de descuento"),
  fechaInicio: Yup.date().required("Ingrese una fecha de inicio").min(new Date(), 'La fecha de inicio no puede ser anterior a hoy'),
  fechaFinal: Yup.date().required("Ingrese una fecha de inicio").min(Yup.ref('fechaInicio'), 'La fecha final debe ser posterior a la fecha de inicio'),
