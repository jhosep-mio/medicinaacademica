...
import { testimoniosValues} from '../../../shared/Interfaces'
import { DeleteItems } from '../../../shared/DeleteItems'
import { LoadingSmall } from '../../../shared/LoadingSmall'

export const ListarTestimonios = (): JSX.Element => {
  ...
  const getAllProductos = async (): Promise<void> => {
    ...
    const request = await axios.post(`${Global.url}/getTestimonios`, data, {
      headers: {
  ...
  useEffect(() => {
    setTitle('Listado de testimonios')
    getAllProductos()
  }, [])
    ...
    <>
      ...
      {loadingComponents
        ...
        <div className="bg-secondary-100 p-8 rounded-xl">
          ...
          {filterDate().map((pro: testimoniosValues) => (
            <div
            ...
            >
              ...
              <div className="md:text-center md:flex md:justify-center">
                ...
                {pro.tipoComentario == "Facebook" && (
                  <img
                    src={`${Global.urlImages}/testimonios/desconocido.png`}
                    alt=""
                    className="w-12 h-12 object-contain"
                  />
                )}
                {pro.tipoComentario == "Aula" && (
                    <img
                      src={`${Global.urlImages}/testimonios/${pro.imagen1}`}
                      alt=""
                      className="w-12 h-12 object-contain"
                    />
