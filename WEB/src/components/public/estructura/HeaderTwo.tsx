...
export const HeaderTwo = (): JSX.Element => {
  ...
  return (
    <>
      ...
      >
        <nav className="navmain2 eonav-cntfluid h-full relative">
          ...
          <div className="w-full hidden md:flex flex-col h-full">
            <div className="flex w-full justify-between items-center gap-4 py-4 h-full">
              ...
              <div className="w-[70%] flex justify-between items-center gap-4 mx-auto px-20">
              ...
              <div className="w-[15%] h-fit flex items-center justify-end gap-4">
                <Link
                  to="/carrito"
                  className="flex gap-2 relative px-4 h-full mr-4"
                >
