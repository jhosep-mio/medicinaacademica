...
import fav from '../../../assets/public/img/logo/favicon.png'
import {
  BsFacebook,
  BsInstagram,
  BsLinkedin,
...
export const Footer = (): JSX.Element => {
  ...
  return (
    <>
      <section className="sect_suscribete" id="news">
        <div className="container">
          <div className="row">
            <div className="col-sm-12 col-md-7">
              <div className="box_boletinsms">
                <h4>SUSCRÍBETE A NUESTRO BOLETÍN MÉDICO</h4>
              </div>
            </div>
            <div className="col-sm-12 col-md-5">
              <form className="frm_boletin" onSubmit={handleSubmit}>
                <div className="row">
                  <span className="response"></span>
                  <div className="col-md-12">
                    <div className="e2e-frmCnt">
                      <input
                        className="form-control e2e_text"
                        id=""
                        type="email"
                        placeholder="Correo "
                        name="email"
      ...
      <FloatingWhatsApp
        ...
        accountName="Medicina Académica"
        statusMessage="En linea"
        placeholder="Envianos un mensaje"
        chatMessage="¡Bienvenid@ a Medicina académica!  Déjanos tu consulta"
        avatar={fav}
        allowEsc
        allowClickAway
        notification
